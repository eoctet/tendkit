...
func TestTUISmokeEnvOverridesAreUnique(t *testing.T) {
...
func TestTUISmokeAutoInitQAndLock(t *testing.T) {
...
func TestTUISmokeInvalidConfigDoesNotChangeFile(t *testing.T) {
	binary := buildTUISmokeBinary(t)
	directory := t.TempDir()
	configPath, lockPath := filepath.Join(directory, "config.json"), filepath.Join(directory, "config.lock")
...
func TestTUISmokePersistsLocalCommandCheck(t *testing.T) {
	binary := buildTUISmokeBinary(t)
	directory := t.TempDir()
	configPath, lockPath := filepath.Join(directory, "config.json"), filepath.Join(directory, "config.lock")
	store := config.New(configPath, lockPath)
...
func TestTUISmokePersistsLocalCommandUpdate(t *testing.T) {
	binary := buildTUISmokeBinary(t)
	directory := t.TempDir()
	configPath, lockPath := filepath.Join(directory, "config.json"), filepath.Join(directory, "config.lock")
...
func TestTUISmokePersistsWorkersEdit(t *testing.T) {
	binary := buildTUISmokeBinary(t)
	directory := t.TempDir()
	configPath, lockPath := filepath.Join(directory, "config.json"), filepath.Join(directory, "config.lock")
	store := config.New(configPath, lockPath)
...
func TestTUISmokePersistsPathScanCandidate(t *testing.T) {
