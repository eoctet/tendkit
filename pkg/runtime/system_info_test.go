...
func TestSystemInfoContract(t *testing.T) {
	...
	t.Run("read-macos-version-propagates-cancellation-and-errors", func(t *testing.T) {
	...
	t.Run("host-platform-and-distribution-architecture", func(t *testing.T) {
	...
	t.Run("detect-system-info-platform-branches", func(t *testing.T) {
	...
	t.Run("macos-version-caches-only-success-and-honors-cancellation", func(t *testing.T) {
	...
	t.Run("parse-os-release-and-normalize-system-info", func(t *testing.T) {
	...
	t.Run("system-info-distribution-mappings", func(t *testing.T) {
	...
	t.Run("os-release-uses-only-whitelisted-ids", func(t *testing.T) {
		for _, test := range []struct {
	...
	t.Run("detect-system-info-caches-success-but-retries-failures", func(t *testing.T) {
	...
	t.Run("linux-github-artifact-matching-fails-closed", func(t *testing.T) {
	...
	t.Run("provider-mappings-and-shell-cover-supported-platforms", func(t *testing.T) {
		for _, test := range []struct {
