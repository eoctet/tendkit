...
func TestMacAppHandlerScanEnumeratesFiltersDeduplicatesAndSorts(t *testing.T) {
...
func TestMacAppHandlerUsesInjectedDefinitionsWithoutGlobalFallback(t *testing.T) {
...
func TestMacAppHandlerSparkleTargetAndBundleID(t *testing.T) {
...
func TestMacAppHandlerMapsJetBrainsProductCodeToCanonicalProviderPackage(t *testing.T) {
...
func TestMacAppHandlerScanHandlesDirectoryAndHomeErrors(t *testing.T) {
...
func TestMacAppHandlerStopsWhenInspectionCancelsContext(t *testing.T) {
	handler := NewMacApp(nil, nil)
...
func TestMacAppHandlerPropagatesInspectionErrors(t *testing.T) {
