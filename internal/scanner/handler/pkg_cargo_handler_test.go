...
func TestCargoInstallRootUsesOnlyConfiguredEnvironmentOrProcessDefaults(t *testing.T) {
...
func TestCargoScanNeverQueriesConfigOrInfo(t *testing.T) {
	root := t.TempDir()
...
func TestCargoHandlerStoresCanonicalInstallPathInCandidate(t *testing.T) {
	root := t.TempDir()
...
func TestCargoHandlerRejectsUnsafeInventoryBinaryNames(t *testing.T) {
...
func TestCargoHandlerRejectsBinarySymlinkOutsideRootWithoutEvidence(t *testing.T) {
	root := t.TempDir()
...
func TestCargoHandlerUsesCargoHomeConfigRootAndIgnoresProjectConfig(t *testing.T) {
	workspace := t.TempDir()
