...
func TestBuiltinPathCatalogContract(t *testing.T) {
	t.Run("built-in-path-application-definitions-contain-core-managers", func(t *testing.T) {
	...
	t.Run("built-in-path-application-catalog-has-one-hundred-unique-definitions", func(t *testing.T) {
	...
	t.Run("built-in-definition-providers-use-registered-vocabulary", func(t *testing.T) {
	...
	t.Run("path-provider-definition-contract", func(t *testing.T) {
	...
	t.Run("node-definition-leaves-download-to-node-lts-provider", func(t *testing.T) {
	...
	t.Run("built-in-descriptions-are-english-defaults", func(t *testing.T) {
		for _, definition := range PathDefinitions() {
	...
	t.Run("flutter-definition-uses-supported-verification-flag", func(t *testing.T) {
		for _, definition := range PathDefinitions() {
	...
	t.Run("path-definitions-preserve-migrated-catalog-contract", func(t *testing.T) {
		definitions := PathDefinitions()
	...
	t.Run("find-path-by-id-is-case-insensitive-and-reports-missing-definitions", func(t *testing.T) {
	...
	t.Run("find-path-by-provider-package-normalizes-package-names-and-reports-missing-definitions", func(t *testing.T) {
	...
	t.Run("path-definitions-returns-fresh-slice", func(t *testing.T) {
	...
	t.Run("mac-app-definitions-contain-match-criteria-and-return-fresh-slices", func(t *testing.T) {
	...
	t.Run("matches-mac-app-catalog-normalizes-key-prefixes-and-names", func(t *testing.T) {
		tests := []struct {
		...
		for _, test := range tests {
			if got := MatchesMacAppCatalog(test.bundleID, test.appName); got != test.want {
				t.Errorf("%s: MatchesMacAppCatalog(%q, %q) = %t, want %t", test.name, test.bundleID, test.appName, got, test.want)
			}
		}
	})
	t.Run("find-mac-app-project-recognizes-known-projects-and-rejects-unknown-bundles", func(t *testing.T) {
		tests := []struct {
